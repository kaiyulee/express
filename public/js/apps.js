$(document).ready(function(){
	...
	if ($('#weather-widget-1').length > 0){
		$("#weather-widget-1").backstretch("http://lollipop.io/img/photo/medium/img.jpg");
	}
	if ($('#weather-widget-2').length > 0){
		$("#weather-widget-2").backstretch("http://lollipop.io/img/photo/medium/img.jpg");
	}
	if ($('#search-heading').length > 0){
		$("#search-heading").backstretch("http://lollipop.io/img/photo/medium/img.jpg");
	}
	if ($('#property-search-wrap').length > 0){
		$("#property-search-wrap").backstretch("http://lollipop.io/img/photo/medium/img.jpg");
	}
	/** END BACK STRETCH **/
